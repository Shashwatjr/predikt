...
function makeStyles(p: LandingPalette) {
  ...
  headline: { color: p.text, fontSize: 28, lineHeight: 33, fontWeight: '900', letterSpacing: -0.7 },
  headlineAccent: { color: p.coral },
  subtext: { color: p.textSoft, fontSize: 13, lineHeight: 19 },
  heroHighlight: {
    borderRadius: 20,
  ...
  heroHighlightCopy: { color: p.textSoft, fontSize: 11, lineHeight: 16 },
  ...
  ctaPrimary: { paddingVertical: 12, alignItems: 'center', borderRadius: radius.md },
